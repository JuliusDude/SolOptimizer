...
export default function DisclaimerBanner() {
  return (
    <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 text-xs text-amber-400 shadow-sm">
      <div className="flex items-start space-x-2.5">
        <AlertCircle className="h-4 w-4 flex-shrink-0 text-amber-500 mt-0.5" />
        <div className="space-y-1">
          <strong className="font-semibold block text-amber-500">
