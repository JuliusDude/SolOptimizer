  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="rounded-xl border border-white/10 bg-[#070A11] p-5 shadow-sm space-y-3">
          <div className="flex items-center justify-between border-b border-white/5 pb-2.5">
            ...
            <button
              ...
              className="flex items-center space-x-1 text-xs font-semibold text-amber-500 hover:text-amber-400"
            >
      ...
      <div className="rounded-2xl border border-solar-300 bg-gradient-to-r from-amber-500/10 via-solar-500/20 to-emerald-500/10 p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center space-x-2 rounded-xl bg-amber-500 px-8 py-3.5 text-base font-bold text-white shadow-lg hover:bg-amber-400 text-slate-950 focus:outline-none focus:ring-4 focus:ring-solar-400 disabled:opacity-50 transition transform active:scale-95"
        >
